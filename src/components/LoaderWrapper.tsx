...
const LoaderWrapper: React.FC<{ children: React.ReactNode }> = ({
  ...
  return (
    <div
      ref={wrapperRef}
      className="fixed inset-0 z-[9999] flex flex-col items-center justify-center bg-[#050505] text-white gap-8"
    >
      <div className="flex space-x-4">
        <div className="loader-dot w-6 h-6 rounded-full bg-[#fdc33c] shadow-[0_0_15px_rgba(253,195,60,0.6)]" />
        <div className="loader-dot w-6 h-6 rounded-full bg-[#fdc33c] shadow-[0_0_15px_rgba(253,195,60,0.6)]" />
        <div className="loader-dot w-6 h-6 rounded-full bg-[#fdc33c] shadow-[0_0_15px_rgba(253,195,60,0.6)]" />
      </div>
